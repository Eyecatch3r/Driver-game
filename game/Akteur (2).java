...
public class Akteur 
{
     ...
     */
    public Akteur(Welt pWelt, double pX, double pY, double pRichtung, double pDrehGeschwindigkeit, double pBewegungsGeschwindigkeit, String pPfadZumBild, Kantenverhalten pKantenverhalten) 
    {
        kWelt = pWelt;
        x = pX;
        y = pY;
